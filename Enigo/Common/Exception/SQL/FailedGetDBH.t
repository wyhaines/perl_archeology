...
use Enigo::Common::Exception::SQL::FailedGetDBH;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::SQL::FailedGetDBH\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::SQL::FailedGetDBH();
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::SQL::FailedGetDBH');
;;;;;
