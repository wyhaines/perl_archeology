...
use Enigo::Common::Exception::SQL::BadScalarQuery;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::SQL::BadScalarQuery\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::SQL::BadScalarQuery
      ('row',$sql);
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::SQL::BadScalarQuery');
;;;;;
