...
use Enigo::Common::Exception::SQL::FailedSQLStatement;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::SQL::FailedSQLStatement\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::SQL::FailedSQLStatement
      ($sql);
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::SQL::FailedSQLStatement');
;;;;;
