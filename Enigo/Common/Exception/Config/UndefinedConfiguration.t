...
use Enigo::Common::Exception::Config::UndefinedConfiguration;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::Config::UndefinedConfiguration\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::Config::UndefinedConfiguration
      ($config);
  };
