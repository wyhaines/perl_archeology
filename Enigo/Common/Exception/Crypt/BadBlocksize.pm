...
=head1 FILE_NAME: $RCSfile: BadBlocksize.pm,v $

=head1 Enigo::Common::Exception::Crypt::BadBlocksize
...
######################################################################
######################################################################
package Enigo::Common::Exception::Crypt::BadBlocksize;
...
@Enigo::Common::Exception::Crypt::BadBlocksize::ISA =
  qw(Enigo::Common::Exception::Crypt);
$Enigo::Common::Exception::Crypt::BadBlocksize::VERSION =
...
Enigo::Common::Exception::Crypt::BadBlocksize.
...
An object blessed into Enigo::Common::Exception::Crypt::BadBlocksize.
...
CryptError: BadBlocksize: $param->{CIPHER} blocksize() call failed.
