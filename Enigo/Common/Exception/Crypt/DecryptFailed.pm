...
=head1 FILE_NAME: $RCSfile: DecryptFailed.pm,v $

=head1 Enigo::Common::Exception::Crypt::DecryptFailed
...
######################################################################
######################################################################
package Enigo::Common::Exception::Crypt::DecryptFailed;
...
@Enigo::Common::Exception::Crypt::DecryptFailed::ISA =
  qw(Enigo::Common::Exception::Crypt);
$Enigo::Common::Exception::Crypt::DecryptFailed::VERSION =
...
An object blessed into Enigo::Common::Exception::Crypt::DecryptFailed.
...
CryptError: DecryptFailed: $param->{CIPHER} encryption failed.
