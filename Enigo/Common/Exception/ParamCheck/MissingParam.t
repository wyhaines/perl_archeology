...
use Enigo::Common::Exception::ParamCheck::MissingParam;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::ParamCheck::MissingParam\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::ParamCheck::MissingParam
      ('text_param','A',2);
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::ParamCheck::MissingParam');
;;;;;
