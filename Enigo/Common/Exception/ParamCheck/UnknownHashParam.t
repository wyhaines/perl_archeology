...
use Enigo::Common::Exception::ParamCheck::UnknownHashParam;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::ParamCheck::UnknownHashParam\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::ParamCheck::UnknownHashParam
      (2);
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::ParamCheck::UnknownHashParam');
;;;;;
