...
use Enigo::Common::Exception::ParamCheck::InvalidParam;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::ParamCheck::InvalidParam\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::ParamCheck::InvalidParam
      ('text_param',123,'A',2);
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::ParamCheck::InvalidParam');
;;;;;
