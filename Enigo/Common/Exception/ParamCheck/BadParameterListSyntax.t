...
use Enigo::Common::Exception::ParamCheck::BadParameterListSyntax;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::ParamCheck::BadParameterListSyntax\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::ParamCheck::BadParameterListSyntax
      (2);
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::ParamCheck::BadParameterListSyntax');
;;;;;
