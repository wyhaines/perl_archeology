...
=head1 FILE_NAME: $RCSfile: NoParameterList.pm,v $

=head1 Enigo::Common::Exception::ParamCheck::NoParameterList
...
######################################################################
######################################################################
package Enigo::Common::Exception::ParamCheck::NoParameterList;
...
@Enigo::Common::Exception::ParamCheck::NoParameterList::ISA =
  qw(Enigo::Common::Exception::ParamCheck);
$Enigo::Common::Exception::ParamCheck::NoParameterList::VERSION =
...
An object blessed into Enigo::Common::Exception::ParamCheck::NoParameterList.
...
ParameterError: NoParameterList: a parameter list must be provided to
ParamCheck.  See the perldoc in Enigo::Common::ParamCheck for more information.
