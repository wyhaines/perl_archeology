...
use Enigo::Common::Exception::ParamCheck::NoParameterList;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::ParamCheck::NoParameterList\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::ParamCheck::NoParameterList
      (2);
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::ParamCheck::NoParameterList');
;;;;;
