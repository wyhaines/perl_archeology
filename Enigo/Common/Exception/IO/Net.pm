...
=head1 FILE_NAME: $RCSfile: Net.pm,v $

=head1 Enigo::Common::Exception::IO::Net
...
Provides a general network exception class.  This class should only be
...
######################################################################
######################################################################
package Enigo::Common::Exception::IO::Net;

use strict;

require Enigo::Common::Exception::IO;

@Enigo::Common::Exception::IO::Net::ISA =
  qw(Error Enigo::Common::Exception::IO);
$Enigo::Common::Exception::IO::Net::VERSION = '2000_06_06_14_47';
...
To create and return an object blessed into Enigo::Common::Exception::IO::Net.
...
An hashref blessed into Enigo::Common::Exception::IO::Net.

=head2 EXAMPLE:

throw Enigo::Common::Exception::IO::DB('The network is down for repairs.');
...
sub new
  {
    ...
    return(bless Enigo::Common::Exception->new
       ({TEXT => "Error: NetworkError: $param->{TEXT}\n<ERROR_LOCATION/>",
         VALUE => $param->{VALUE}}),
       $self);
  }
