...
use Enigo::Common::Exception::IO::File::NotFound;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::IO::File::NotFound\n\n";
...
eval
  {
    $exception = new Enigo::Common::Exception::IO::File::NotFound
      ('/tmp/myfile.log');
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::IO::File::NotFound');
;;;;;
