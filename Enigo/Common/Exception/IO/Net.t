...
use Enigo::Common::Exception::IO::Net;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Exception::IO::Net\n\n";

my $text = "The network is down";
my $derived_text;
my $eval_error;
my $exception;
...
eval
  {
    $exception = new Enigo::Common::Exception::IO::Net
      ($text);
  };
...
check('new() returns an object blessed into the correct class.',
      ref($exception) ne 'Enigo::Common::Exception::IO::Net');
;;;;;
