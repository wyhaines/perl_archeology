...
use Enigo::Common::Log::Dispatch::Output::Exception::MinGreaterThanMax;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Log::Dispatch::Output::Exception::MinGreaterThanMax\n\n";
...
eval
  {
    $exception = new Enigo::Common::Log::Dispatch::Output::Exception::MinGreaterThanMax
      ({MIN => $min,
        MAX => $max});
  };
