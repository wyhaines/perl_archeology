...
use Enigo::Common::Log::Dispatch::Output::Exception::NoMinLevel;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Log::Dispatch::Output::Exception::NoMinLevel\n\n";
...
eval
  {
    $exception = new Enigo::Common::Log::Dispatch::Output::Exception::NoMinLevel
      ($fake_self);
  };
