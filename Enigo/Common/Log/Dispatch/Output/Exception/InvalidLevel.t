...
use Enigo::Common::Log::Dispatch::Output::Exception::InvalidLevel;
use IO::Scalar;
use Algorithm::Diff;

print "Testing Enigo::Common::Log::Dispatch::Output::Exception::InvalidLevel\n\n";

my $level = 'really big bad super duper problem';
my $derived_text;
...
eval
  {
    $exception = new Enigo::Common::Log::Dispatch::Output::Exception::InvalidLevel
      ($level);
  };
